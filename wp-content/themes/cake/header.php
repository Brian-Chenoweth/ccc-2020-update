...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-123797488-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-123797488-1');
</script>

	
<!-- For Google ads	 -->
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-123797488-2">
</script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
	...
	<div id="Wrapper">
		...
		<header id="Header">
			...
			<script type="application/ld+json">
			{
			  ...
			  "image": "https://www.columbiachildrenscenter.com/wp-content/uploads/2018/09/CCC-logo.png",
			  "@id": "https://www.columbiachildrenscenter.com/",
